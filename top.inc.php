        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">CODE-XPO-Leave Managemant </a>
            ...
            <div class="top-right">
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active"> Welcome <?php echo $_SESSION['USER_NAME'] ?></a>
                    </div>
