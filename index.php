...
if ($_SESSION['ROLE'] != 1) {
   header('locatin:add_employee.php?id=' . $_SESSION['USER_ID']);
   die();
}
                        ...
                        <tbody>
                           ...
                           while ($row = mysqli_fetch_assoc($res)) { ?>
                              <tr>
                                 ...
                                 <td><a href="add_department.php?id=<?php echo $row['id'] ?>">Edit</a>
                                    <a href="index.php?id=<?php echo $row['id'] ?>&type=delete">Delete</a></td>
                              </tr>
                           <?php
                              $i++;
                           } ?>
